...
extern "C" int luaopen_remoteApiLua(lua_State *L) {
	...
	registerVariable(L,"sim_boolparam_joint_motion_handling_enabled",(boost::lexical_cast<std::string>(int(sim_boolparam_joint_motion_handling_enabled))).c_str());
	registerVariable(L,"sim_boolparam_path_motion_handling_enabled",(boost::lexical_cast<std::string>(int(sim_boolparam_path_motion_handling_enabled))).c_str());
	...
	registerVariable(L,"sim_jointmode_motion",(boost::lexical_cast<std::string>(int(sim_jointmode_motion))).c_str());
